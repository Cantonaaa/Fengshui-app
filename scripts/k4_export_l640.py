#!/usr/bin/env python3
"""K4：yolov8l-worldv2 @ 640 重导（平均嵌入合并，17 输出类）。
...
产物：yolov8l_world_v2_640.onnx（后续 pnnx → ncnn）
...
ONNX_OUT = "yolov8l_world_v2_640.onnx"
IMGSZ = 640
RISK_DOC = "docs/model_risk_640.md"
...
def main():
    print("== K4: yolov8l-worldv2 @ 640 重导（17 类）==")
