...
守卫为警告式：cosine >0.95 中止；0.8-0.95 记入 docs/model_risk_m960.md（真机重点验证）。

产物：yolov8m_world_v2_960.onnx（后续 pnnx → ncnn）
...
ONNX_OUT = "yolov8m_world_v2_960.onnx"
IMGSZ = 960
RISK_DOC = "docs/model_risk_m960.md"
